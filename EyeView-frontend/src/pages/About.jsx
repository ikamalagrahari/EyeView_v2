...
function About() {
  return (
    <div className="min-h-screen bg-(--color-richblack-900) text-white px-6 md:px-20 py-16">
      <div className="max-w-5xl mx-auto space-y-8">

        <h1 className="text-4xl md:text-5xl font-bold text-(--color-richblack-5)">
         EyeView
        </h1>

        <p className="text-lg text-(--color-richblack-100) leading-relaxed">
        ...
        {/* Feature List */}
        <div className="border-t border-(--color-richblack-700) pt-8 mt-8">
          <h2 className="text-2xl font-semibold text-(--color-richblack-25) mb-4">
            Why Choose EyeView?
          </h2>
          <ul className="space-y-4 text-(--color-richblack-100) text-lg">
